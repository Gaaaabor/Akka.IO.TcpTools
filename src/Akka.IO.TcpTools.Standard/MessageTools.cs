...
namespace Akka.IO.TcpTools.Standard
{
    ...
    {
        private static readonly Regex _keyMatcher = new Regex("(?<=Sec-WebSocket-Key:).*");
        ...
        /// </summary>
        public static byte[] CloseMessage = new byte[] { CloseOpCode, 2, 3, 232 };

        /// <summary>
        /// Represents a standard WebSocket ping message.
        /// </summary>
        public static byte[] PingMessage = new byte[] { PingOpCode, 2, 3, 232 };

        /// <summary>
        /// Represents a standard WebSocket pong message.
        /// </summary>
        public static byte[] PongMessage = new byte[] { PongOpCode, 2, 3, 232 };
        ...
        public static ulong GetPayloadLength(byte[] message)
        {
            ...
            {
                payloadLength = BitConverter.ToUInt64(new byte[] { message[9], message[8], message[7], message[6], message[5], message[4], message[3], message[2] }, 0);
                return payloadLength;
            }
        ...
        public static string CreateAck(string key)
        {
            ...
            var keyWithMagicHashed = SHA1.Create().ComputeHash(Encoding.UTF8.GetBytes(keyWithMagic));
